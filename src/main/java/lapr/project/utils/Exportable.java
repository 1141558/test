...
public interface Exportable {
     ...
     * @throws TransformerException         when there's a tranformation error.
     * @throws ParserConfigurationException when there's a parse error.
     */
     ...
     *
     * @return structured String containing content.
     * @throws ParserConfigurationException when parsing in not possible.
     */
