...
public class XMLParser {
     ...
     * @throws TransformerException when there's a transformation error.
     */
     ...
     * @throws Exception when there's an exception reading from a file.
     */
     ...
     * @throws Exception when there's an error writing to a file.
     */
